...
ann = MLPClassifier(  # -----The architecture:------#
    ...
    learning_rate_init=0.002,  # What is the initial learning rate? in some optimizers the learning rate changes.
    ...
    warm_start=False,
    beta_1=0.88, # if we fit at the second time, do we start from the last fit?
